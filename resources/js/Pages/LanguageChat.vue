                ...
                <div ref="chatContainer" data-test="chat-container" class="flex-1 overflow-y-auto px-4 py-4 sm:py-6">
                    ...
                    <div v-if="!activeChat && chats.length === 0" class="flex h-full items-center justify-center">
                        <div class="w-full max-w-2xl text-center px-4">
                            <div
                                class="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 sm:mb-6 sm:h-20 sm:w-20">
                                <svg class="h-6 w-6 text-blue-600 sm:h-10 sm:w-10" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                            ...
                            <h2 class="mb-1.5 text-lg font-semibold text-gray-900 sm:mb-2 sm:text-2xl">Start Your Language Journey
                            </h2>
                            <p class="mb-4 text-xs text-gray-600 sm:mb-8 sm:text-base">Practice {{ targetLanguage }}
                                with AI-powered conversations tailored to your level</p>
                            <button @click="handleNewChat"
                                class="mb-3 inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-xs font-medium text-white transition-colors hover:bg-blue-700 sm:mb-6 sm:px-6 sm:py-3 sm:text-base">
                                <svg class="h-3.5 w-3.5 sm:h-5 sm:w-5" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="grid grid-cols-1 gap-2 sm:grid-cols-3 sm:gap-4">
                                <div class="rounded-lg border border-gray-200 bg-white p-2.5 sm:p-4">
                                    <div
                                        class="mb-1.5 flex h-7 w-7 items-center justify-center rounded-full bg-green-100 mx-auto sm:mb-2 sm:h-10 sm:w-10">
                                        <svg class="h-3.5 w-3.5 text-green-600 sm:h-5 sm:w-5" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                    </div>
                                    <h3 class="mb-0.5 text-xs font-medium text-gray-900 text-center sm:mb-1 sm:text-base">Adaptive
                                        Learning</h3>
                                    <p class="text-[10px] text-gray-600 text-center leading-tight sm:text-sm">AI adjusts to your level</p>
                                </div>
                                <div class="rounded-lg border border-gray-200 bg-white p-2.5 sm:p-4">
                                    <div
                                        class="mb-1.5 flex h-7 w-7 items-center justify-center rounded-full bg-purple-100 mx-auto sm:mb-2 sm:h-10 sm:w-10">
                                        <svg class="h-3.5 w-3.5 text-purple-600 sm:h-5 sm:w-5" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <h3 class="mb-0.5 text-xs font-medium text-gray-900 text-center sm:mb-1 sm:text-base">Natural
                                        Conversation</h3>
                                    <p class="text-[10px] text-gray-600 text-center leading-tight sm:text-sm">Practice real-world dialogue
                                    </p>
                                </div>
                                <div class="rounded-lg border border-gray-200 bg-white p-2.5 sm:p-4">
                                    <div
                                        class="mb-1.5 flex h-7 w-7 items-center justify-center rounded-full bg-orange-100 mx-auto sm:mb-2 sm:h-10 sm:w-10">
                                        <svg class="h-3.5 w-3.5 text-orange-600 sm:h-5 sm:w-5" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                                        </svg>
                                    </div>
                                    <h3 class="mb-0.5 text-xs font-medium text-gray-900 text-center sm:mb-1 sm:text-base">Instant
                                        Feedback</h3>
                                    <p class="text-[10px] text-gray-600 text-center leading-tight sm:text-sm">Get corrections and
                                        suggestions</p>
                                </div>
                            </div>
                        </div>
