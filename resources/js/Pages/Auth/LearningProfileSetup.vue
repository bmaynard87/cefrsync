...
const handleSubmit = () => {
    form.post(route('learning-profile.store'));
};
</script>

<template>
    <Head title="Learning Profile Setup" />

    <AuthLayout
        title="Welcome to CefrSync!"
        :subtitle="`Hi ${user.first_name}, let's set up your learning profile`"
    >
        <Card>
            <CardHeader>
                <CardTitle>Learning Profile Setup</CardTitle>
                <CardDescription>
                    Let's personalize your language learning experience. This will only take a moment.
                </CardDescription>
            </CardHeader>
