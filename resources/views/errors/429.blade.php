...
<head>
    ...
    <title>Too Many Requests - CefrSync</title>
...
<body class="antialiased">
    <div class="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center px-6">
        <div class="max-w-2xl w-full text-center">
            ...
            <div class="flex justify-center mb-8">
                <div class="relative">
                    <div class="flex items-center justify-center rounded-full bg-indigo-100 h-32 w-32">
                        <svg class="h-16 w-16 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                        </svg>
                    </div>
                    <div class="absolute -bottom-2 -right-2 rounded-full bg-indigo-500 px-3 py-1">
                        <span class="text-white font-bold text-sm">429</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Countdown Timer -->
            <div class="mb-8">
                <div class="inline-block bg-blue-100 rounded-lg px-6 py-4">
                    <p class="text-sm text-gray-600 mb-2">You can try again in</p>
                    <p class="text-3xl font-bold text-blue-600" id="countdown">60</p>
                    <p class="text-sm text-gray-600 mt-2">seconds</p>
                </div>
            </div>
            ...
            <p class="mt-8 text-sm text-gray-500">
                This helps us keep CefrSync running smoothly for everyone. Thank you for your patience!
            </p>
        </div>
    </div>
