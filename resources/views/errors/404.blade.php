...
<head>
    ...
    <title>Page Not Found - CefrSync</title>
...
<body class="antialiased">
    <div class="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center px-6">
        <div class="max-w-2xl w-full text-center">
            ...
            <div class="flex justify-center mb-8">
                <div class="relative">
                    <div class="flex items-center justify-center rounded-full bg-blue-100 h-32 w-32">
                    ...
                    <div class="absolute -bottom-2 -right-2 rounded-full bg-red-500 px-3 py-1">
                        <span class="text-white font-bold text-sm">404</span>
                    </div>
                </div>
            </div>
